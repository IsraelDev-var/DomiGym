...
import { createMiembroSchema, updateMiembroSchema, idParamSchema, registroCompletoSchema } from './miembro.schema';
...
router.post('/registro-completo', authorize('ADMIN', 'GERENTE', 'EMPLEADO'), validate(registroCompletoSchema), controller.registrarCompleto);
